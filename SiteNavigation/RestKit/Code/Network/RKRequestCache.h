...
/**
 */
extern NSString * const RKRequestCacheHeadersExtension;
extern NSString * const RKRequestCacheDateHeaderKey;
extern NSString * const RKRequestCacheStatusCodeKey;
extern NSString * const RKRequestCacheMIMETypeKey;
extern NSString * const RKRequestCacheURLKey;
